...
const ElectionModal: React.FC<ElectionModalProps> = ({ isOpen, onClose, election, isCreateMode }) => {
  ...
  const [
    ...
    { data: fetchedUsersData, isLoading: isLoadingUsers, isError: isErrorUsers, isSuccess: isUsersSuccess }
          ...
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="w-full lg:w-1/3 bg-gray-50 p-4 rounded-lg shadow-inner overflow-auto max-h-[600px]">
              ...
              <table className="w-full table-auto border border-gray-300 text-lg">
                ...
                <tbody>
                  {fetchedUsersData && fetchedUsersData.length > 0 ? (
                    fetchedUsersData.map((voter, idx) => (
                      <tr key={voter._id}>
                    ...
                    <tr>
                      <td colSpan={2} className="text-center py-2 text-gray-500">Chưa có cử tri</td>
                    </tr>
                  )}
                </tbody>
              </table>
